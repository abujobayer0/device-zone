            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-4 md:gap-x-8 w-full">
              <div className="relative group flex justify-center items-center h-full w-full">
                <img
                  ...
                  alt="girl-image"
                />
                <button className="dark:bg-[#f3f3f3] dark:text-[#1f1e1f] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 bottom-4 z-10 absolute text-base font-medium leading-none text-[#f3f3f3] py-3 w-36 bg-[#1f1e1f]">
                  Phone
                </button>
